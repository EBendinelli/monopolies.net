export const SITE = {
  ...
  orbit1RevolveTime: 24, // in seconds, only used in view, not in CSS
  orbit2RevolveTime: 32, // in seconds, only used in view, not in CSS
  orbit3RevolveTime: 40, // in seconds, only used in view, not in CSS
} as const;
